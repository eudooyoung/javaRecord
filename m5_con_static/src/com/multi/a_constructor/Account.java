...
//    this => 인스턴스(생성된 객체)의 주소값을 가르킴
    ...
    public Account(String name, int money) { // 이름을 초기 설정하는 생성자;
        this.name = name;
        this.money = money;
    }


    public Account(String name, String field) { // 이름을 초기 설정하는 생성자;
        this.name = name;
        this.field = field;
    }

    public Account(String name, String field, int money) { // 이름을 초기 설정하는 생성자;
//        this.name = name;
//        this.field = field;
//        this.money = money;
        this(name, field); // this()생성자를 호출해서 사용
