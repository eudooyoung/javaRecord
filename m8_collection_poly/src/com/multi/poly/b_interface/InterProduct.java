...
public interface InterProduct {
    ...
    // 추상(미완성 메소드)와 모든 클래스에서 공용으로 사용 할 상수들을 한데 묶어놓은 **추상전용 클래스**를 인터페이스라고한다.
    // 클래스로부터 상속 받을 수 없고 implements로 사용
...
//    인터페이스는 생성자를 가질 수 없다.
//    public void method1() {}  구현체가 있는 일반 메소드 생성 불가

    void method1(); // 묵시적으로 public abstract가 앞에 붙음
