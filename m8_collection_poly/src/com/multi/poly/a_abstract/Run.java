...
public class Run {
    public static void main(String[] args) {
         ...
         * 추상클래스를 사용하려면 추상클래스를 상속받은 **하위 클래스**를 이용해서 인스턴스를 생성해야 한다.
         * 이 때 추상클래스는 **상위 타입**으로 사용될 수 있으며, 다형성을 이용할 수 있다.
         *
...
//        Product p1 = new Product(); Product는 추상 클래스. 객체 생성 불가
...
//        더 큰 타입인 Product로 받을 수 있음
        ...
        product.method3(); // SmartPhone에 구현된 클래스 호출

        Product.method2(); // 스테틱은 클래스명으로 바로 접근
