...
public class Inet {
    ...
    // 서버 -> 소켓 -> 포트 -> IP -> 네트워크 -> IP -> 포트 -> 소켓 -> 클라이언트의 프로세스
        try {
            ...
            System.out.println("내 컴퓨터 이름: " + localIp.getHostName());
            System.out.println("내 아이피 주소: " + localIp.getHostAddress());

            InetAddress naverIp = InetAddress.getByName("www.naver.com");

            System.out.println("네이버 이름: " + naverIp.getHostName());
            System.out.println("네이버 주소: " + naverIp.getHostAddress());
            //후이즈 사용방법 확인
