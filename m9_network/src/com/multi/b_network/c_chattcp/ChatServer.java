...
public class ChatServer {
    ...
    ExecutorService threadPool = Executors.newFixedThreadPool(100); // 자바에서 제공하는 스레드 풀
    Map<String, SocketClient> chatRoom = Collections.synchronizedMap(new HashMap<>()); // 스레드에 안전한 map 컬렉션 사용
...
//                    throw new RuntimeException(e);
    ...
    public void sendtoAll(SocketClient sender, String message ) {
        ...
        for (SocketClient sc : socketClients) { // 보내는 사람을 제외한 클라이언트에게 메시지 전송
