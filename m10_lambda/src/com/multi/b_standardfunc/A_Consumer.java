...
//    return값이 없음
    ...
    */
    public void method01() {
        ...
        consumer1 = (String str) -> System.out.println(str);

        Consumer<String> consumer2 = (String str) -> System.out.println(str + "붙여짐");

        consumer1.accept("안녕");

        consumer1.andThen(consumer2).accept("??"); // 두개 사용??
        ...
        */
        ...
        biConsumer.accept("안녕", "??");

        DoubleConsumer doubleConsumer = (double num) -> System.out.println(num);
